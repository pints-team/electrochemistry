...
struct Efun {
  ...
  Efun(const Efun &other)
      : Estart(other.Estart), Ereverse(other.Ereverse), dE(other.dE),
  ...
  Efun(const double Estart, const double Ereverse, const double dE,
       const double omega, const double phase, const double dt)
      : Estart(Estart), Ereverse(Ereverse), dE(dE), omega(omega), phase(phase),
        dt(dt), treverse(std::abs(Estart - Ereverse)),
        direction(Ereverse > Estart ? 1 : -1), Edata(NULL){};
